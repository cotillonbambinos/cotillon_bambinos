/* ============================================================
   ...
   VARIANTES (opcional):
   • Si un producto viene en distintos colores/sabores/tamaños, en vez de
     crear una card por cada uno, agregale "variantLabel" (el nombre de
     la opción, ej: "Color", "Sabor", "Presentación") y un array "variants"
     con un bloque {} por cada opción (mirá el ejemplo en "Crema Ledevit"
     o "Pasta Ballina" más abajo).
   • Cada variante puede tener su propio precio, imagen y stock. Si una
     variante no tiene imagen propia, usa la imagen general del producto.
   • El precio/imagen/stock que están afuera de "variants" (a nivel del
     producto) son los que se muestran por defecto en la card, antes de
     que el cliente elija una opción.
   • Productos sin "variants" funcionan exactamente igual que antes: no
     hace falta tocar nada en el resto del catálogo.
   ============================================================ */
    ...
    products: [
      {
        ...
        variantLabel: "Sabor",
        variants: [
          { id: "chantilly", label: "Chantilly", price: 6200, stock: "disponible", img: "assets/img/crema-ledevit-chantilly-500gr.webp", desc: "Rica, práctica y lista para usar. Ideal para rellenar, cubrir y decorar tortas, postres y facturas." },
          { id: "frutilla",  label: "Frutilla",  price: 6200, stock: "disponible", img: "assets/img/crema-ledevit-frutilla-500gr.webp",  desc: "Lista para batir, con sabor a frutilla. Queda firme para decorar y le da color a la torta sin teñir de más." },
          { id: "vainilla",  label: "Vainilla",  price: 6200, stock: "disponible", img: "assets/img/crema-ledevit-vainilla-500gr.webp",  desc: "La clásica de vainilla: neutra, rinde bien y es la base perfecta cuando querés agregarle tu propio color o sabor." },
          { id: "chocolate", label: "Chocolate", price: 6600, stock: "disponible", img: "assets/img/crema-ledevit-chocolate-500gr.webp", desc: "Sabor a chocolate marcado, ideal para rellenos golosos y coberturas que no se bajan con el calor." }
        ]
      },
      {
        id: 5,
      ...
      {
        id: 6,
        name: "Dulce de Leche Repostero Vacalin",
        category: "Repostería",
        price: 3600,
        medida: "400 g",
        ...
        variants: [
          { id: "original",     label: "Pote Original",     price: 3600, stock: "disponible", img: "assets/img/dulce-de-leche-repostero-vacalin-400gr.webp",              desc: "De textura firme y sabor intenso. Ideal para rellenar y decorar tortas, alfajores y postres." },
          { id: "transparente", label: "Pote Transparente", price: 3500, stock: "disponible", img: "assets/img/dulce-de-leche-repostero-vacalin-400gr-potTransparente.webp", desc: "El mismo Vacalin repostero, en pote transparente para que veas el punto y el color. Mismo precio, un toque más económico." }
        ]
      },
      {
        id: 8,
      ...
      },
      {
        ...
        rating: 5,
        featured: true,
        desc: "Crema ideal para rellenos, coberturas o postres.",
        variantLabel: "Sabor",
        variants: [
          { id: "mani",     label: "Maní",     price: 6000, stock: "disponible", img: "assets/img/micky-mani-mapsa-450gr.webp",     desc: "Crema de maní ideal para rellenos, coberturas o postres." },
          { id: "frutilla", label: "Frutilla", price: 6000, stock: "disponible", img: "assets/img/micky-frutilla-mapsa-450gr.webp", desc: "Crema de frutilla ideal para rellenos, coberturas o postres." },
          { id: "menta",    label: "Menta",    price: 6000, stock: "disponible", img: "assets/img/micky-menta-mapsa-450gr.webp",    desc: "Crema de menta ideal para rellenos, coberturas o postres." },
          { id: "pistacho", label: "Pistacho", price: 9600, stock: "disponible", img: "assets/img/micky_Pistacho-Mapsa-450gr.webp", desc: "Crema de pistacho ideal para rellenos, coberturas o postres." }
        ]
      },
      {
        id: 14,
        ...
        variantLabel: "Color",
        variants: [
          { id: "blanco",   label: "Blanco",   swatch: "#FFFFFF", price: 6000, stock: "disponible", img: "assets/img/Pasta-ballina-blanco-500gr.webp",   desc: "El básico que no puede faltar: cubre parejo y es la base para teñir del color que necesites." },
          { id: "negro",    label: "Negro",    swatch: "#1A1A1A", price: 6000, stock: "disponible", img: "assets/img/Pasta-ballina-negro-500gr.webp",    desc: "Color intenso ya listo, sin manchar las manos. Perfecto para detalles, contornos y temáticas oscuras." },
          { id: "rojo",     label: "Rojo",     swatch: "#D6293E", price: 6000, stock: "disponible", img: "assets/img/Pasta-ballina-rojo-500gr.webp",     desc: "Rojo vivo difícil de lograr tiñendo en casa. Ideal para Mickey, autos, corazones y temáticas fuertes." },
          { id: "rosa",     label: "Rosa",     swatch: "#FF9FC7", price: 6000, stock: "disponible", img: "assets/img/Pasta-ballina-rosa-500gr.webp",     desc: "El más pedido para cumples de princesas y baby showers de nena. Tono pastel listo para estirar." },
          { id: "verde",    label: "Verde",    swatch: "#4CAF50", price: 6000, stock: "disponible", img: "assets/img/Pasta-ballina-verde-500gr.webp",    desc: "Verde parejo para dinos, fútbol o naturaleza. Se estira fácil y no se cuartea al cubrir." },
          { id: "amarillo", label: "Amarillo", swatch: "#F5D020", price: 6000, stock: "disponible", img: "assets/img/Pasta-ballina-amarillo-500gr.webp", desc: "Amarillo alegre para temáticas de abejas, soles y Pooh. Cubre sin rastros de color disparejo." }
        ]
      },
      {
        id: 20,
